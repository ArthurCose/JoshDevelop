import {SettingsSection, SettingsTable} from "/javascript/client/Settings.js";

export default class AceSettings extends SettingsSection
{
  constructor(session)
  {
    super("Text Editor", session);
